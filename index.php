...
<body>
	...
	<nav id="sidebar" class="">
		...
		<ul>
			<li class="active" href="page/profile.txt" header="Профиль" onclick="selectMenu(this)">
			...
			<li href="page/group.txt" header="Список группы" onclick="selectMenu(this)">
			...
			<li onclick="selectMenu(this)" href="page/duty.txt" header="Таблица">
