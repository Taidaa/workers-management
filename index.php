...
<body>
	...
	<nav id="sidebar" class="">
		...
		<ul>
			<li class="active" href="page/profile.php" header="Профиль" onclick="selectMenu(this)">
			...
			<li href="page/group.php" header="Список группы" onclick="selectMenu(this)">
			...
			<li onclick="selectMenu(this)" href="page/duty.php" header="Таблица">
	...
	<iframe src="page/todo.php" id='todolist' height='32'></iframe>
	<!-- END OF CONTENT -->
